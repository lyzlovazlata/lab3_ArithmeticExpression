...
/*
* —интаксический автомат. ¬ нем очень много: проверка скобок, проверка синтаксиса (унарность, колво операндов) а так же создание постфикса
* ¬роде как это и получилось что-то типа восход€щего разбора или как его там?
*/

class SyntAutomat {

	using SFunction = void (SyntAutomat::*)(Word);
	// Ќа вход идет очередь - из лексического автомата, на выход - очередь результативна€
	TQueue<Word> in;
	TQueue<int> errs;
	int err_ind;
